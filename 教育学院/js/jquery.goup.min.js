...
(function($){$.fn.goup=function(options){$.fn.goup.defaultOpts={appear:200,scrolltime:800,imgsrc:"img/goup.png",width:72,place:"bottom-right",fadein:500,fadeout:500,opacity:0.5};var opts=$.extend({},$.fn.goup.defaultOpts,options);return this.each(function(){var goup=$(this);goup.html("<a><img /></a>");var goupa=$("#goup a");var goupimg=$("#goup a img");goup.css({"position":"fixed","display":"block","width":"'"+opts.width+"px'","z-index":"9"});goupa.css("opacity",opts.opacity);
goupimg.attr("src",opts.imgsrc);goupimg.width(opts.width);goupimg.hide();$(function(){$(window).scroll(function(){if($(this).scrollTop()>opts.appear)goupimg.fadeIn(opts.fadein);else goupimg.fadeOut(opts.fadeout)});$(goupa).hover(function(){$(this).css("opacity","1.0");$(this).css("cursor","pointer")},function(){$(this).css("opacity",opts.opacity)});$(goupa).click(function(){$("body,html").animate({scrollTop:0},opts.scrolltime);return false})});if(opts.place==="top-right")goup.css({"top":"1%","right":"1%"});
else if(opts.place==="top-left")goup.css({"top":"1%","left":"1%"});else if(opts.place==="bottom-right")goup.css({"bottom":"0.6%","right":"0.3%"});else if(opts.place==="bottom-left")goup.css({"bottom":"1%","left":"1%"});else goup.css({"bottom":"1%","right":"1%"})})}})(jQuery);